...
M_ni_10 = Matrix([
    [0, 1, 0, 0], 
    [0, f_10+1, f_10+1, f_10], 
    [0, 0, 0, 1], 
    [1, f_10, f_10, f_10]])
M_ni_11 = Matrix([
    [0, 1, 0, 0], 
    [0, f_11+1, f_11+1, f_11], 
    [0, 0, 0, 1], 
    [1, f_11, f_11, f_11]])
M_ni_12 = Matrix([
    [0, 1, 0, 0], 
    [0, f_12+1, f_12+1, f_12], 
    [0, 0, 0, 1], 
    [1, f_12, f_12, f_12]])
#类MARS特殊结构n轮（多轮）加密矩阵为M_2，解密矩阵为M_ni_2
#用expand()函数确保结果为展开式
#M_n = expand(M_1*M_2*M_3*M_4*M_5*M_6*M_7*M_8*M_9*M_10*M_11*M_12*M_13)
M_n = expand(M_ni_1*M_ni_2)
